    ...
    <div class="col-9">
      ...
      <form action="/komik/update/<?= $komik['id']; ?>" method="post">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            <!-- operasi ternary (if else satu baris) untuk nampilin pesan error bootstrap  -->
            <input type="text" class="f orm-control  <?= ($validation->hasError('judul')) ? 'is-invalid' : '';  ?>" id="judul" name="judul" autofocus value="<?= (old('judul')) ? old('judul') : $komik['judul']   ?>">
